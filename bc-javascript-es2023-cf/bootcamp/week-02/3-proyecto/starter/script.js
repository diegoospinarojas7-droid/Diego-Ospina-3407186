...
const DOMAIN_NAME = "Venta De Productos Agricolas";
...
const itemName = "Productos Agricolas";
...
const itemQuantity = 150; // reemplaza 0 con el número adecuado
...
console.log("valor como texto:", quantityText);
console.log("convertido:", typeof quantityText);
console.log("");
...
console.log("Valor pendiente:", pendingValue);
console.log("tipo de valor:", typeof pendingValue);
