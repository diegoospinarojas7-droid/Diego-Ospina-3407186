...
console.log("=========================================");
console.log("Venta de productos agricolas - FICHA 1202");
console.log("=========================================");
console.log("");
...
console.log("nombre: GreenHarvest");
console.log("correo: greenhaverstvents.gmail.com");
console.log("numero:3209855784");
console.log("id: GREN-1204");
...
console.log("Categoría: Venta de Productos Agricolas");
...
console.log("Valor principal:, 23000");
...
console.log("Valor calculado:    ", 3 * 23000); // TODO: reemplaza 0 con tu cálculo
...
console.log("Total registros:13000");
...
console.log("COMERCIALIZACION: ¡Explora el universo con JavaScript!");
